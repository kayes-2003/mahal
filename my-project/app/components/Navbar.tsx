  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50">
      ...
      <nav className="relative flex items-center justify-between px-10 md:px-20 lg:px-30 py-8 text-white">
        ...
        {/* Right Menu */}
        <div className="hidden md:flex gap-8 text-sm tracking-wide">
          <Link href="/reviews" className="cursor-pointer hover:text-blue-600 active:underline underline-offset-4">Reviews</Link>
          <Link href="/contact" className="cursor-pointer hover:text-blue-600 active:underline underline-offset-4">Contact</Link>
        </div>
      ...
      >
        ...
        <Link href="/reviews" className="px-4 py-2 text-white hover:underline hover:text-black hover:bg-amber-100 underline-offset-4" onClick={() => setOpen(false)}>Reviews</Link>
